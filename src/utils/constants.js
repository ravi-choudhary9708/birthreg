...
export const STATUS_CONFIG = {
    ...
    PENDING_OPERATOR: {
        ...
        bg: "#eff6ff",
        border: "#bfdbfe",
        description: "Verification complete. Forwarded to the operator for CRS portal submission.",
        step: 2,
    },
    APPLIED_ON_CRS: {
        label: "Applied on CRS Portal",
        color: "#7c3aed",
        bg: "#f5f3ff",
        border: "#ddd6fe",
        description: "The operator has submitted your application on the CRS portal. Processing in progress.",
        step: 3,
    },
    APPLIED_ON_CSC: {
        label: "Applied on CRS Portal",
